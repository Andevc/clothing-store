...
(2, 7, 4, 'Denim Jeans', 'denim-jeans', '', 0, 39.99, 29.99, 'Classic denim jeans with a modern fit.', 'Slim fit, durable fabric, multiple sizes.', 'jeans, denim, slim fit', 'Best Seller', 'product', '2023-01-25 08:00:00', NULL),
(3, 10, 1, 'Sports Jacket', 'sports-jacket', '', 0, 59.99, 49.99, 'Lightweight sports jacket perfect for outdoor activities.', 'Water-resistant, zip pockets, adjustable hood.', 'jacket, sports, outdoor', '', 'product', '2021-11-12 08:00:00', NULL),
...
(6, 4, 8, 'Leather Wallet', 'leather-wallet', '', 0, 29.99, 24.99, 'Premium leather wallet with multiple compartments.', 'Durable, stylish, compact design.', 'wallet, leather, accessories', '', 'product', '2021-09-05 08:00:00', NULL),
...
(8, 1, 9, 'Graphic Hoodie', 'graphic-hoodie', '\r\nhttps://res.cloudinary.com/dn2zvlabb/image/upload/v1737319558/sweater-2_bdnyiq.jpg', 0, 49.99, 39.99, 'Trendy hoodie with a unique graphic design.', 'Soft fleece, kangaroo pocket, hooded.', 'hoodie, graphic, casual', 'Limited Edition', 'product', '2025-01-20 03:27:34', NULL),
...
(15, 11, 9, 'Puffer Vest', 'puffer-vest', '', 0, 59.99, 45.99, 'Warm and lightweight puffer vest.', 'Insulated, sleeveless, zip pockets.', 'vest, puffer, winter', 'Trending', 'product', '2021-01-15 08:00:00', NULL),
...
(19, 4, 1, 'Plaid Scarf', 'plaid-scarf', '', 0, 19.99, 14.99, 'Cozy plaid scarf for cold weather.', 'Soft material, oversized design, trendy look.', 'scarf, plaid, winter', 'Best Seller', 'product', '2022-11-25 08:00:00', NULL),
...
(25, 8, 9, 'Denim Jacket', 'denim-jacket', '', 0, 79.99, 64.99, 'Timeless denim jacket with a modern fit.', 'Durable fabric, stylish design, unisex.', 'jacket, denim, casual', 'Trending', 'product', '2022-01-12 08:00:00', NULL),
